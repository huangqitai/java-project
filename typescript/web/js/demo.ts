...
let JOB_FORMDATA_NEW={};
function Converter():object {
    for (let key in JOB_FORMDATA){
        if (key=="JOB_FILES_LINK.IFJQD") {
            let JOB_FILES_NEW = Converter_XXX(JOB_FORMDATA["JOB_FILES_LINK.IFJQD"],"JOB_FILES.");
            JOB_FORMDATA_NEW["JOB_FILES_LINK.IFJQD"] = JOB_FILES_NEW;
        }
        else if (key=="JOB_SQRXXB_OLD_LINK.OLD_IQLR") {
            let JOB_SQRXXB_NEW = Converter_XXX(JOB_FORMDATA["JOB_SQRXXB_OLD_LINK.OLD_IQLR"],"JOB_SQRXXB_OLD.");
            JOB_FORMDATA_NEW["JOB_SQRXXB_OLD_LINK.OLD_IQLR"] = JOB_SQRXXB_NEW;
        }
        else if (key=="JOB_GLQLZMXXB_LINK.OLD_IQLDJ") {
            let JOB_GLQLZMXXB_NEW = Converter_XXX(JOB_FORMDATA["JOB_GLQLZMXXB_LINK.OLD_IQLDJ"],"JOB_GLQLZMXXB.");
            JOB_FORMDATA_NEW["JOB_GLQLZMXXB_LINK.OLD_IQLDJ"] = JOB_GLQLZMXXB_NEW;
        }
        else if (key=="JOB_SQRXXB_LINK.IQLR") {
            let JOB_SQRXXB_NEW = Converter_XXX(JOB_FORMDATA["JOB_SQRXXB_LINK.IQLR"],"JOB_SQRXXB.");
...
function Converter_XXX(JOB_DATA:object,JOB_XXX:String):object {
    let JOB_XXX_DATA = JOB_DATA[0];
    let JOB_XXX_NEW=[];
    let map={};
    for (let key in JOB_XXX_DATA) {
