...
/**
 * @Author: xn-h
 * @Date: 2019/8/12 0012 15
 * @Description: SM3 算法加密
 */
public class SM3Util {
    ...
    public static String hashHex(byte[] b) {
        try {
            return com.qitai.utils.SM3Util.byteArrayToHexString(com.qitai.utils.SM3Util.hash(b));
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static void main(String[] args) {
        String client_secret = "45548dd4d5204ee79c4a5eac839b5ffd7d35e854ca9f4520aa4a37f111e3315e";
        long l = System.currentTimeMillis();
        System.out.println(l);
        System.out.println(hashHex(l+client_secret));
        //System.out.println(hashHex("954d4cd8c6b34e6a9993cde793aa0e9c"));
    }
}
