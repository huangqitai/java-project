...
{
	com.qitai.utils.TreeNode<T> parent=null;
	List<com.qitai.utils.TreeNode<T>> children=new ArrayList<>();
	T prop;
	 ...
	 * @return
	 */
	public List<com.qitai.utils.TreeNode<T>> getChildren(){
		return children;
	}
	 ...
	 * @return
	 */
	public com.qitai.utils.TreeNode<T> getParent()
	{
		return parent;
	}
	 ...
	 * @param parent
	 */
	public void setParent(com.qitai.utils.TreeNode<T> parent)
	{
		this.parent = parent;
	}
	 ...
	 * @return
	 */
	public boolean existChild(com.qitai.utils.TreeNode<T> node, boolean bRecursive){
		for(com.qitai.utils.TreeNode<T> n : children){
	 ...
	 * @return
	 */
	public com.qitai.utils.TreeNode<T> findChild(T nodeProp, boolean bRecursive)
	{
		for(com.qitai.utils.TreeNode<T> n : children){
			if(n.propEquals(nodeProp)) return n;
			if(bRecursive){
				com.qitai.utils.TreeNode<T> temp=n.findChild(nodeProp,true);
				if(temp!=null)
					return temp;
			}
		}
	 ...
	 * @param nodeProp
	 */
	public com.qitai.utils.TreeNode<T> findParent(T nodeProp)
	{
		if(parent==null) return null;
