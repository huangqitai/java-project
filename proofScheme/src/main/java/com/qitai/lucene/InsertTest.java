...
public class InsertTest {
    ...
    public void createIndexTest() throws IOException {
        ...
        for (File file : fileList) {
            ...
            if (!file.isDirectory()) {
                ...
                Field fileSizeField = new TextField("fileSize", String.valueOf(fileSize), Field.Store.YES);
    ...
    public void searchIndexTest() throws IOException {
        ...
        Query query = new TermQuery(new Term("fileName", "javase.txt"));
        // 执行查询
